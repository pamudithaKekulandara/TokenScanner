...
export const InvalidToken = ({ navigation }) => {
  ...
  const handleSignup = (credentials) => {
    axios
      .post(
        'https://travels-ticket-booking.herokuapp.com/invalidToken/add',
        credentials
      )
      .then((res) => {
    ...
    <KeyBoardAvoidingWrapper>
      <StyledContainer>
        ...
        <InnerContainer>
          ...
          <SubTitle>Add About Invalid Token</SubTitle>
          {show && (
            <DateTimePicker
            ...
            {({
              ...
              <StyledFormArea>
                ...
                <InputCd
                  ...
                  placeholder='Enter the ID'
                  placeholderTextColor={darkLight}
                  onChangeText={handleChange('reson')}
                  onBlur={handleBlur('reson')}
                  value={values.reson}
                />
